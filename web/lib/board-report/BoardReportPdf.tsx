...
const styles = StyleSheet.create({
  ...
  coverBrandText: { fontSize: 13, fontWeight: 600 },
  coverTitle: {
    fontSize: 36,
    fontWeight: 700,
    marginTop: 24,
  ...
  coverSubtitle: { fontSize: 14, color: PALETTE.ink2, marginTop: 8 },
  coverPeriod: { fontSize: 12, color: PALETTE.ink3, marginTop: 32 },
  sectionTitle: {
    fontSize: 16,
    fontWeight: 700,
    marginTop: 18,
  ...
  return (
    <Document>
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.cover}>
          <View>
            ...
            <Text style={styles.coverTitle}>Board cybersecurity report</Text>
            <Text style={styles.coverSubtitle}>{data.org.nameEn}</Text>
            <Text style={styles.coverPeriod}>
              Period: {data.period} · Generated: {data.generatedAt.slice(0, 10)}
            </Text>
          </View>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.sectionTitle}>Posture sub-scores</Text>
        ...
        <Text style={styles.sectionTitle}>CISO scorecard</Text>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.sectionTitle}>Top vulnerabilities</Text>
        <View style={styles.kpiRow}>
          <View style={styles.kpiTile}>
      ...
      <Page size="A4" style={styles.page}>
        <Text style={styles.sectionTitle}>Cyber insurance readiness</Text>
        <View style={styles.kpiRow}>
          <View style={styles.kpiTile}>
        ...
        <Text style={styles.sectionTitle}>Planned actions next quarter</Text>
        <Text style={styles.para}>
