  ...
  return (
    <View>
      ...
      <Callout lang="ar" title="خانة التوقيع">
        يكتمل القبول بثلاثة توقيعات: (١) الراعي التنفيذي لجهة العميل؛
        (٢) مدير برنامج التسليم لدى الموزِّع؛ (٣) قائد القبول الفني لدى
        الجهة. توقيع مؤرَّخ ومُرفق بهذا المستند يعادل قبول التسليم. يُغلَق
        الارتباط عند التوقيع المقابل.
      </Callout>
      <P lang="ar">
